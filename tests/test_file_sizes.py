...
OVER = {
    "holophyte/loop.py": 1588,
    "holophyte/pr.py": 1033,
    "holophyte/supervisor.py": 1297,
    "tests/test_factory_config.py": 2191,
    "tests/test_factory_loop.py": 6908,
    "tests/test_serve.py": 3156,
    "tests/test_supervisor_sweep.py": 2359,
}
...
PINNED = {
    ...
    "holophyte/config_tables.py": 558,
    ...
    "tests/test_cli_requeue.py": 214, "tests/test_file_sizes.py": 199,
    "tests/test_holophyte_package.py": 301, "tests/test_provider.py": 578,
