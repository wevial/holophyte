...
OVER = {
    ...
    "tests/test_claim.py": 1540,
    "tests/test_factory_config.py": 2188,
    "tests/test_factory_loop.py": 4396,
...
PINNED = {
    ...
    "holophyte/claim.py": 879, "holophyte/cli.py": 460,
    ...
    "tests/loop_fixture.py": 374, "tests/test_babysitter.py": 466,
    "tests/test_cli.py": 114,
    "tests/test_cli_approve.py": 269, "tests/test_cli_requeue.py": 214,
    "tests/test_file_sizes.py": 200, "tests/test_holophyte_package.py": 307,
    "tests/test_pool.py": 842, "tests/test_provider.py": 578,
