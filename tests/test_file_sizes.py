...
OVER = {
    ...
    "tests/test_factory_loop.py": 6692,
...
PINNED = {
    ...
    "holophyte/reconcile.py": 467, "holophyte/reexec.py": 94,
    "holophyte/report.py": 160, "store/read.py": 926,
    "store/schema.py": 740, "tests/test_babysitter.py": 466,
    ...
    "tests/test_store_status.py": 311, "tests/test_store_surface.py": 265,
